...
module ommp_interface
   ...
   use mod_electrostatics, only: ommp_electrostatics_type, set_def_solver, set_def_matv
   use mod_topology, only: ommp_topology_type, set_frozen
   ...
   use mod_inputloader, only : mmpol_init_from_mmp, mmpol_init_from_xyz
