...
contains
    ...
    subroutine df_electrostatics_for_geomgrad(df, eel)
        ...
        !! 1. E_m2q electric field of static and polarizable multipoles at
        !!    charge sites
        ...
        integer(ip) :: i, j, a, k, n_cpt, n_mm, n_pts, n_charges
        real(rp) :: kernel(5), dr(3), tmpV, tmpE(3), tmpEgr(6), tmpHE(10)
