module mod_electrostatics
    ...
    real(rp), allocatable, public :: E_M2D(:,:,:)
    ...
    subroutine potential_D2E(cpt, V)
        ...
        use mod_mmpol, only: amoeba, pol_atoms, ipd, cpol
        ...
        if(amoeba) then
            do i=1, pol_atoms
                do j=1, n_cpt
                    ...
                    call mu_elec_prop(ipd(:,i,OMMP_AMOEBA_D), &
                                      dr, kernel, .true., tmpV, &
                                      .false., tmpE, .false., tmpEgr, & 
                                      .false., tmpHE)
    ...
    subroutine potential_M2E(cpt, V)
        ...
        use mod_mmpol, only: amoeba, mm_atoms, q, cmm
